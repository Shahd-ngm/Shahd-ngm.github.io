...
let stories = [
	...
	'I am a fish, your storyteller.',
	'I am here to help you understand the Fish world',
	'It is a fictional world, but world of knowledge'
];
...
function changeText(){
	...
	fishDiv.style.left = pos / (height * 4) * width + 'px';
	...
	// Set color of current section button to blue
	navButtons[sectionNum].style.backgroundColor = "#87CEFA";
}